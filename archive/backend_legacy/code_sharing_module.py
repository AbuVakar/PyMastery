...
async def create_code_snippet(snippet_data: CodeSnippetCreate, user_id: str, user_name: str, code_snippets_collection):
...
async def get_code_snippet(share_id: str, code_snippets_collection):
...
async def get_user_snippets(user_id: str, code_snippets_collection):
